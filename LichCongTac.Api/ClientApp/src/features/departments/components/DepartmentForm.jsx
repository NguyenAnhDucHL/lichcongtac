export function DepartmentForm({ formData, setFormData, editId, loading, error, onSubmit, onReset }) {
  ...
  return (
    <form onSubmit={onSubmit} className="max-w-[600px] mb-10 flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4">
        <div className="font-medium md:w-[150px] shrink-0">Tên phòng ban<span className="text-red-500">*</span></div>
